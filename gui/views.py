...
#             arcade.get_window().show_view(MenuView(ScreenConfiguration(), view_controller))
...
#         arcade.get_window().show_view(MainGameView(self.config, EASY))
...
#
#     def on_click(self, event):
#         arcade.get_window().show_view(MainGameView(self.config, MEDIUM))
#         self.manager.disable()
#
...
#
#     def on_click(self, event):
#         arcade.get_window().show_view(MainGameView(self.config, HARD))
#         self.manager.disable()
#
#
...
#     def on_key_press(self, symbol: int, modifiers: int):
#         if symbol == arcade.key.ESCAPE:
#             arcade.get_window().show_view(MenuView(self.config, view_controller))
#
#
# def main():
#     """ Main function """
...
#
#     menu_view = MenuView(config, view_controller)
